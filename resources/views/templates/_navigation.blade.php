    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link @if(isset($tab) && $tab == 'contacts')active @endif"
                ...
                <li class="nav-item">
                    <a class="nav-link @if(isset($tab) && $tab == 'feedback')active @endif"
                    ...
                    @if (Auth::user()->role === 'admin')
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="adminDropdown">
                                <a class="dropdown-item @if(isset($tab) && $tab == 'categories')active @endif"
                                   href="/admin/categories">Categories</a>
                                <a class="dropdown-item @if(isset($tab) && $tab == 'products')active @endif"
                                   href="/admin/products">Products</a>
                                <a class="dropdown-item @if(isset($tab) && $tab == 'tags')active @endif"
